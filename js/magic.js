...
function ballAnimation() {
    ...
    if (traveledSinceDot >= 80 || traveledSinceDot <= 10)
        ctx.drawImage(pacmanClosedImg, -pacmanSize / 2, -pacmanSize / 2, pacmanSize, pacmanSize);
    else
        ctx.drawImage(pacmanOpenedImg, -pacmanSize / 2, -pacmanSize / 2, pacmanSize, pacmanSize);
    ctx.restore();
    if (traveledSinceDot >= 90)
        traveledSinceDot = 0;
